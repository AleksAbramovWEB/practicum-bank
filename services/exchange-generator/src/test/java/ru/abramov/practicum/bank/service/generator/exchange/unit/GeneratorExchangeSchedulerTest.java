package ru.abramov.practicum.bank.service.generator.exchange.unit;
...
import ru.abramov.practicum.bank.service.generator.exchange.scheduler.GeneratorExchangeScheduler;
...
class GeneratorExchangeSchedulerTest {
    ...
    static class Config {
        ...
        @Bean GeneratorExchangeScheduler generatorExchangeScheduler(ExchangeClient exchangeClient) {
    ...
    void run_ShouldSendRateDtoForAllCurrencies() {
        ...
        for (Currency currency : Currency.values()) {
            verify(exchangeClient).updateExchangeRate(argThat(dto ->
                    dto.getCurrency() == currency &&
                            dto.getValue() != null &&
