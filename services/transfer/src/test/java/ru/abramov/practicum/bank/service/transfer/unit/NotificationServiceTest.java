package ru.abramov.practicum.bank.service.transfer.unit;
...
import ru.abramov.practicum.bank.service.transfer.service.impl.NotificationServiceImpl;
...
class NotificationServiceTest {
    ...
    @Configuration
    static class Config {
        @Bean NotificationClient notificationClient() { return mock(NotificationClient.class); }
        @Bean NotificationService notificationService(NotificationClient client) {
    ...
    void notify_ShouldSendCorrectMail() {
        ...
        verify(notificationClient).sendMail(argThat(mail ->
                mail.getEmail().equals("test@bank.com") &&
