...
import ru.abramov.practicum.bank.service.transfer.service.impl.TransferServiceImpl;
...
class TransferServiceTest {
    ...
    void setup() {
        ...
        from.setVersion(1L);
        from.setCurrency(ru.abramov.practicum.bank.client.account.model.Currency.RUB);

        to.setId(2L);
        to.setUserId("other-user");
        to.setBalance(BigDecimal.valueOf(200));
        to.setVersion(2L);
        to.setCurrency(ru.abramov.practicum.bank.client.account.model.Currency.RUB);
    ...
    void transfer_ShouldRollback_WhenToAccountChangeFails() {
        ...
        updatedFrom.setCurrency(ru.abramov.practicum.bank.client.account.model.Currency.RUB);
