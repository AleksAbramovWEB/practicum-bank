...
contracts {
    ...
    baseClassForTests.set("ru.abramov.practicum.bank.service.account.contract.BaseContractTest")
}
...
openApiGenerate {
    ...
    apiPackage.set("ru.abramov.practicum.bank.client.account.api")
    modelPackage.set("ru.abramov.practicum.bank.client.account.model")
    invokerPackage.set("ru.abramov.practicum.bank.client.account.invoker")
    configOptions.set(
        mapOf(
